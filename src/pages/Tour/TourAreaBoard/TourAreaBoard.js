...
import TourAreaTop from "./components/TourAreaTop";
import { BoardFooter } from "../../../components/Board/Board";

const TourAreaBoard = ({ match }) => {
    ...
    return (
        <Template title="관광지 관리" navCtg="tour">
            ...
            <TourAreaTop handleChangePageCtrl={handleChangePageCtrl} />
