...
import User from './components/member/MemberTable';
...
const routes = [
    ...
    { path: "/member/user/insert", title: "회원정보", component: User},

    { path: "/member/driver", exact: true, title: "회원정보", component: User },
    { path: "/member/manager", exact: true, title: "회원정보", component: User },
