...
import PlaceCode from './pages/place/place-code/PlaceCode'
import PlaceCodeForm from './pages/place/place-code-form/PlaceCodeForm'
import RegionCode from './pages/place/region-code/RegionCode';
...
const routes = [
    ...
    { path: "/place/place-code-form",  title: "관광지 추가", component: PlaceCodeForm},
